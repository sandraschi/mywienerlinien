...
class DataLoader:
    ...
    def load_lines(self, force_reload: bool = False) -> List[Line]:
        ...
        db_target = None
        try:
            from .database import db as db_rel, ROUTE_TYPE_NAMES as route_type_names
            db_target = db_rel
        except Exception:
            try:
                from database import db as db_abs, ROUTE_TYPE_NAMES as route_type_names  # type: ignore
                db_target = db_abs
