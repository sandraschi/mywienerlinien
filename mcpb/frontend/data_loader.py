...
class DataLoader:
    ...
    def load_lines(self, force_reload: bool = False) -> list[Line]:
        ...
        db_target = None
        route_type_names_map = None

        try:
            from .database import ROUTE_TYPE_NAMES
            from .database import db as db_rel

            route_type_names_map = ROUTE_TYPE_NAMES
            db_target = db_rel
        except Exception:
            try:
                from database import ROUTE_TYPE_NAMES
        ...
        try:
            ...
            for route in routes:
                ...
                route_type_name = route_type_names_map.get(route_type_code, "Unknown")
    ...
    def get_line_by_name(self, line_name: str) -> Line | None:
    ...
    def get_gtfs_line_catalog(self) -> list[dict[str, Any]]:
        ...
        try:
            ...
            route_type_names_local = ROUTE_TYPE_NAMES
            db_local = db_rel
        except Exception:
            try:
                from database import ROUTE_TYPE_NAMES  # type: ignore
    ...
    def get_gtfs_route(self, line_name: str) -> dict[str, Any] | None:
        db_target = None
        try:
            from .database import db as db_rel
    ...
    def get_station_by_rbl(self, rbl: str) -> Station | None:
    ...
    def get_route_by_line(self, line_name: str) -> Route | None:
