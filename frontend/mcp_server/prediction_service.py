...
class DelayPredictionModel:
    ...
    def train_model(
        ...
        try:
            ...
            features_train, features_test, y_train, y_test = train_test_split(
                features_matrix, y, test_size=0.2, random_state=42
            )
    ...
    def _predict_historical(self, line: str, target_time: datetime) -> DelayPrediction | None:
...
# Singleton instance
_prediction_service: DelayPredictionModel | None = None
