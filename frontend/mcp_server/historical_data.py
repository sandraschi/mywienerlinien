...
class HistoricalDataCollector:
    ...
    def __init__(self, db_manager, storage_dir: Optional[Path] = None):
    ...
    def get_delay_history(self, line: Optional[str] = None, days: int = 30) -> list[dict]:
    ...
    def analyze_delay_patterns(self, line: Optional[str] = None) -> list[DelayPattern]:
    ...
    def get_pattern_for_time(self, line: str, target_time: datetime) -> Optional[DelayPattern]:
    ...
    def export_training_data(self, output_file: Optional[Path] = None) -> Path:
