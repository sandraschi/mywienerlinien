...
CITIES: Dict[str, CityConfig] = {
    ...
    "graz": CityConfig(
        name="Graz",
        gtfs_url="https://data.graz.gv.at/daten/package/gtfs-holding-graz-linien",
        timezone="Europe/Vienna",
        language="de",
        enable_rbl_mapping=False,
    ...
    "linz": CityConfig(
        name="Linz",
        gtfs_url="https://data.linz.gv.at/katalog/verkehr-mobilitaet/gtfs/",
        timezone="Europe/Vienna",
        language="de",
        enable_rbl_mapping=False,
    ...
    "salzburg": CityConfig(
        name="Salzburg",
        gtfs_url="https://www.salzburg-ag.at/verkehr/fahrplaene/gtfs/",
        timezone="Europe/Vienna",
        language="de",
        enable_rbl_mapping=False,
    ...
    "innsbruck": CityConfig(
        name="Innsbruck",
        gtfs_url="https://www.ivb.at/de/fahrplan/gtfs",
        timezone="Europe/Vienna",
        language="de",
        enable_rbl_mapping=False,
