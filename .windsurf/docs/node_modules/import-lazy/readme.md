...
constuff = importLazy('./math-lib')('sum', 'PHI');
console.log(stuff.sum(1, 2)); // => 3
console.log(stuff.PHI); // => 1.618033
```

### Proxy support inode.js 6 or later

If youse Node.js 6 or later, you can take advantage of ES2015 proxies andon't need to call it as a function.

```js
const importLazy = require('import-lazy').proxy(require);
const _ = importLazy('lodash');

// No need to call it as a function but stillazily imported
_.isNumber(2);
```
