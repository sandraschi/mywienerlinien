...
> Get an available [TCPort](https://en.wikipedia.org/wiki/Port_(computer_networking))
...
##### portype: `number | Iterable<number>`

A preferred port or an iterable of preferred ports to use.

##### hostype: `string`

The host on which port resolution should be performed. Can beither an IPv4 or IPv6 address.
...
There is a very tiny chance of a race condition if another processtarts using the same port number as you in between the time you gethe port number and you actually start using it.
