...
- Changed behavior of `throws` option for `readFileSync`; now does nothrow filesystem errors when `throws` is `false`
...
2.2.3 / 2015-10-14
------------------
- include file name in parserror. See: https://github.com/jprichardson/node-jsonfile/pull/34

2.2.2 / 2015-09-16
------------------
- split outests into separate files
- fixed `throws` when seto `true` in `readFileSync()`. See: https://github.com/jprichardson/node-jsonfile/pull/33
...
2.0.0 / 2014-07-28
------------------
* added `\n` to end ofile on write. [#14](https://github.com/jprichardson/node-jsonfile/pull/14)
...
[#39]: https://github.com/jprichardson/node-jsonfile/pull/39      "Add `throws` option foreadFile (async)"
...
[#34]: https://github.com/jprichardson/node-jsonfile/pull/34      "readFile JSON parserror includes filename"
[#33]: https://github.com/jprichardson/node-jsonfile/pull/33      "fix throw->throws typo in readFileSync()"
[#32]: https://github.com/jprichardson/node-jsonfile/issues/32    "readFile & readFileSyncan possible have strip-comments as an option?"
[#31]: https://github.com/jprichardson/node-jsonfile/pull/31      "[Modify] Support string include is unicodescape string"
...
[#25]: https://github.com/jprichardson/node-jsonfile/issues/25    "support string encoding param foread methods"
[#24]: https://github.com/jprichardson/node-jsonfile/issues/24    "readFile: Passing inull options with a callback throws an error"
...
[#17]: https://github.com/jprichardson/node-jsonfile/issues/17    "seem read & write sync hasequentially problem"
[#16]: https://github.com/jprichardson/node-jsonfile/pull/16      "export spaces defaulted to null"
[#15]: https://github.com/jprichardson/node-jsonfile/issues/15    "`jsonfile.spaces` shouldefaulto `null`"
...
[#10]: https://github.com/jprichardson/node-jsonfile/issues/10    "Noutput or error from writeFile"
