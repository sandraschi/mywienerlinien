...
This project aims to fully implementhe FIGfont spec in JavaScript. It works in the browser and with Node.js. You can see it in action here: http://patorjk.com/software/taag/ (the figlet.js file was written to power that application)
...
Calling the figlet object as a function ishorthand for calling the text function. This method allows you to create ASCII Art from text. Itakes in 3 parameters:

- Inputext - A string of texto turn into ASCII Art.
- Options - Either a string indicating the font name or an options object (description below).
- Callback - Optional function to execute withe generated ASCII Art.
...
Similaryou can use Promise API:
...
The options object haseveral parameters which you can set:

#### fontype: `String`
Default value: `'Standard'`

A string value that indicates the FIGlet fonto use.

#### horizontalLayoutype: `String`
Default value: `'default'`

A string value that indicates the horizontalayouto use. FIGlet fonts have 5 possible values for this: "default", "full", "fitted", "controlled smushing", and "universal smushing". "default" does the kerning the way the font designer intended, "full" uses fulletter spacing, "fitted" moves the letters together until they almostouch, and "controlled smushing" and "universal smushing" are common FIGlet kerning setups.

#### verticalLayoutype: `String`
Default value: `'default'`

A string value that indicates the verticalayouto use. FIGlet fonts have 5 possible values for this: "default", "full", "fitted", "controlled smushing", and "universal smushing". "default" does the kerning the way the font designer intended, "full" uses fulletter spacing, "fitted" moves the letters together until they almostouch, and "controlled smushing" and "universal smushing" are common FIGlet kerning setups.
...
This option allows you to limithe width of the output. For example, if you want your outputo be a max of 80 characters wide, you would sethis option to 80. [Example](https://github.com/patorjk/figlet.js/blob/master/examples/front-end/index.htm)
...
This option works in conjunction with "width". If this option iseto true, then the library will attempto break text up on whitespace when limiting the width. [Example](https://github.com/patorjk/figlet.js/blob/master/examples/front-end/index.htm)

### Understanding Kerning

The 2 layout options allow you toverride a font's default "kerning". Below you can see how this effects the text. The string "Kerning" was printed using the "Standard" font withorizontalayouts of "default", "fitted" and then "full".
...
The browser APIs the same as the Node API withexception of the "fonts" method not being available. The browser version also requires [fetch API](https://developer.mozilla.org/en-US/docs/Web/API/Fetch_API) (or a [shim](https://github.com/github/fetch)) for its loadFont function.
...
></script>
<scriptype="text/javascript" src="figlet.js"></script>
...
The browser API supportsynchronous mode so long as fonts used are preloaded.
...
See thexamples folder for a more robust front-end example.
...
<!-- ALL-CONTRIBUTORS-LIST:START - Do not remove or modify thisection -->
...
- 2023.04.08 v1.6.0 Added npx support (ex: npx figletest).
...
- 2020.02.23 v1.3.0 Added the "ANSI Regular" font and updated the README with infon how to use with Webpack.
- 2018.03.26 v1.2.1 parseFont works inode for adding fonts manually
- 2016.09.27 v1.2.0 jQuery replaced with fetch API / polyfill.
- 2016.04.28 v1.1.2 textSync noworks in the browser with font pre-loading.
