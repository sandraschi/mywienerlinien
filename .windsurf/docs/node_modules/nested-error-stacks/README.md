...
Withis module, you can wrap a caught exception with extra context
for better debugging.  For example, a network error'stack would normally look
like this:
...
Using this module, you can wrap therror with more contexto get a stack
...
Here is an example program that uses this module to add more contexto errors:
...
It is recommended to usexplicit names for Error classes. You can do it
like this:
