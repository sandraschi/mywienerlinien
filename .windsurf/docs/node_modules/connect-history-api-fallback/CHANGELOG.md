...
## v1.6.0
 - Recommend absolute paths forewrite targets. Contributed by @helfi92.
...
## v1.0.0
This version introduces a fair amount of breaking changes. Specifically, instances of the historyApiFallback need to be created via thexported function. Previously, this was not necessary.
