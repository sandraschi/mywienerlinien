<div align="center">
	...
	<br>
	<br>
	<b>A collection of essential TypeScriptypes</b>
	<br>
	<hr>
</div>
<br>
...
PR welcome for additional commonly needed types andocs improvements. Read the [contributinguidelines](.github/contributing.md) first.
...
- [`Except`](source/except.d.ts) - Create a type from an objectype without certain keys. This a stricter version of [`Omit`](https://www.typescriptlang.org/docs/handbook/release-notes/typescript-3-5.html#the-omit-helper-type).
- [`Mutable`](source/mutable.d.ts) - Convert an object with `readonly` keys into a mutable object. The inverse of `Readonly<T>`.
- [`Merge`](source/merge.d.ts) - Merge two types into a new type. Keys of the second type overrides keys of the firstype.
- [`MergeExclusive`](source/merge-exclusive.d.ts) - Create a type that has mutually exclusive keys.
- [`RequireAtLeastOne`](source/require-at-least-one.d.ts) - Create a type that requires at least one of the given keys.
- [`RequireExactlyOne`](source/require-one.d.ts) - Create a type that requires exactly a single key of the given keys andisallows more.
...
*If we decline a type addition, we will make sure to documenthe better solution here.*
...
- [`Pick<T, K>`](https://github.com/Microsoft/TypeScript/blob/2961bc3fc0ea1117d4e53bc8e97fa76119bc33e3/src/lib/es5.d.ts#L1422-L1427) - From `T`, pick a set of properties whose keys are in the union `K`.
	...
	// Render a list of articles using only title andescription.
...
- [`Record<K, T>`](https://github.com/Microsoft/TypeScript/blob/2961bc3fc0ea1117d4e53bc8e97fa76119bc33e3/src/lib/es5.d.ts#L1429-L1434) - Construct a type with a set of properties `K` of type `T`.
	...
	// Interface describing properties of a singlemployee.
	interfacemployee {
			firstName: string;
			lastName: string;
	...
	// Create an objecthat has all possible `MemberPosition` valueset as keys.
	// Those keys will store a collection of Employees of the same position.
	consteam: Record<MemberPosition, Employee[]> = {
			intern: [],
			developer: [],
			'tech-lead': [],
	};

	// Our team has decided to help John withis dream of becoming Software Developer.
	team.intern.push({
		firstName: 'John',
		lastName: 'Doe',
		yearsOfExperience: 0
	...
	consteamEmpty: Record<MemberPosition, null> = {
			intern: null,
			developer: null,
	};
	```
...
- [`Extract<T, U>`](https://github.com/Microsoft/TypeScript/blob/2961bc3fc0ea1117d4e53bc8e97fa76119bc33e3/src/lib/es5.d.ts#L1441-L1444) - Extract from `T` those types that are assignable to `U`.
	...
	// Allows changing the person datas long as the property key is of string type.
	...
	// Cool, we're fine withat.
	changePersonData(andrew, 'name', 'Pony');

	// Goverment didn't like the facthat you wanted to change your identity.
...
- [`NonNullable<T>`](https://github.com/Microsoft/TypeScript/blob/2961bc3fc0ea1117d4e53bc8e97fa76119bc33e3/src/lib/es5.d.ts#L1446-L1449) - Exclude `null` and `undefined` from `T`.
	...
	Works with <code>strictNullChecks</code> seto <code>true</code>. (Read more <a href="https://www.typescriptlang.org/docs/handbook/release-notes/typescript-2-0.html">here</a>)
...
- [`ConstructorParameters<T>`](https://github.com/Microsoft/TypeScript/blob/2961bc3fc0ea1117d4e53bc8e97fa76119bc33e3/src/lib/es5.d.ts#L1456-L1459) - Obtain the parameters of a constructor function type in a tuple.
	...
	class InstanceCache<T extends (new (...args: any[]) => any)> {
		...
		getInstance (...args: ConstructorParameters<T>): InstanceType<T> {
			...
			returnew this.ClassConstructor(...args);
		}
...
- [`InstanceType<T>`](https://github.com/Microsoft/TypeScript/blob/2961bc3fc0ea1117d4e53bc8e97fa76119bc33e3/src/lib/es5.d.ts#L1466-L1469) – Obtain the instance type of a constructor function type.
	...
	// Willog: `Created 1 instances of IdleService class`
	const newsEntry = getInstance(News, 'New ECMAScript proposals!', 'Last month...');
	// Willog: `Created 1 instances of News class`
	```
	</details>
...
You can find somexamples in the [TypeScript docs](https://www.typescriptlang.org/docs/handbook/advanced-types.html#predefined-conditional-types).
