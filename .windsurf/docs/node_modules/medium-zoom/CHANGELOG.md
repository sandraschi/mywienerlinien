...
- introduce pure bundle (JS and CSSeparated) ([#204](https://github.com/francoischalifour/medium-zoom/issues/204) and [#206](https://github.com/francoischalifour/medium-zoom/issues/206)) ([0a05b46](https://github.com/francoischalifour/medium-zoom/commit/0a05b4626b0f2820ae5bc3e2b0ef081244679750))
...
- Export default exportype as ESModule ([#82](https://github.com/francoischalifour/medium-zoom/issues/82)) ([ed45fcb](https://github.com/francoischalifour/medium-zoom/commit/ed45fcbe0ae318f70411d8975c0c557ccf81f92b))
...
- **Methods become chainable**. All methods except getters and animation methods (`open()`, `close()` and `toggle()`) return the zoom objecto allow method calls to be chained.
...
- **Animation methods return promises**. `open()`, `close()` and `toggle()` return promises resolving withe zoom for acting accordingly when the animation is completed. To remain compatible with IE10, promises are converted to no-operation functions if unavailable.
...
- HD image scales the firstime on Firefox (264c81f9d54b7272fa260616f117c3149be89123)
...
- Do notrigger the zoom when target is `null` (can happen on fast double click): 3f795b44877af341ed65ae7c1bc764cc5122cdfb
...
- Support `scrollTop` position Firefox: ee13718c38a7a4ba486cacfb50f2861dd1adb8ad
...
- Apply the default selector only when the plugin is givenone (#7): aa8ff0ff6743e0bc011ea162ff068a2ddbb0f9ab
...
- Exporthe plugin for npm usage (#1): affca211ac6999f1d2c554205d5b216c37fc7c1c
