...
However, please notice thathis only provides a [limited subset of Date methods](#patterns).<br>
...
```js
constinydate = require('tinydate');
const fooDate = new Date('5/1/2017, 4:30:09 PM');

constamp = tinydate('Currentime: [{HH}:{mm}:{ss}]');
...
```js
constoday = new Date('2019-07-04, 5:30:00 PM');

// Example custom dictionary:
//   - Adds {MMMM}
//   - Overrides {DD}
constamp = tinydate('Today is: {MMMM} {DD}, {YYYY}', {
...
tinydate    x 160,834,214 ops/sec ±0.21% (96 runsampled)
tinytime    x  44,602,162 ops/sec ±0.34% (97 runsampled)
time-stamp  x     888,153 ops/sec ±1.27% (86 runsampled)
```

## License

MIT © [Lukedwards](https://lukeed.com)
