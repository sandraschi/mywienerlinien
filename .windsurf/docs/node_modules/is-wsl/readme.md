...
> Check if the process is running inside [Windowsubsystem for Linux](https://msdn.microsoft.com/commandline/wsl/about) (Bash on Windows)
...
// When running inside Windowsubsystem for Linux
console.log(isWsl);
//=> true
```
