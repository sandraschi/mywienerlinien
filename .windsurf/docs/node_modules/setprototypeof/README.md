...
A simple cross platform implementation to sethe prototype of an instianted object.  Supports all modern browsers and at least back to IE8.
...
```typescript
import setPrototypeOfrom 'setprototypeof'
```
