...
> Gethe latest version of anpm package
...
(async () => {
	...
	// Also works with semveranges andist-tags
...
- [package-json](https://github.com/sindresorhus/package-json) - Gethe package.json of a package from the npm registry
