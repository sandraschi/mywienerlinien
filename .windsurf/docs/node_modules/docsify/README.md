...
You can use Gitpod (a free online VS Code-like IDE) for contributing. With a single click it'llaunch a workspace and automatically:
...
## Sponsorsupporthis project by becoming a sponsor. Your logo will show up here with a link to your website. [[Become a sponsor](https://opencollective.com/docsify#silver-sponsors)]
...
A preview of Docsify's PR andevelop branch is <a href="https://vercel.com/?utm_source=docsifyjs&utm_campaign=oss" target="_blank">Powered by <img src="https://cdn.jsdelivr.net/gh/docsifyjs/docsify/docs/_media/vercel_logo.svg" alt="Vercel" width="133px"></a>
