...
==================
  ...
  * deps: finalhandler@1.0.1
    ...
    - deps: debug@2.6.3.6.0 / 2017-02-17
==================

  * deps: debug@2.6.1
    - Allow colors in workers
    - Deprecated `DEBUG_FD` environment variable seto `3` or higher
    - Fix error when running undereact Native
...
==================
  ...
  * deps: finalhandler@0.4.0
    - Fix a false-positive when unpiping inode.js 0.8
...
==================
  ...
  * deps: finalhandler@0.3.4
    - deps: debug@~2.1.3.3.4 / 2015-01-07
==================
...
==================
  ...
  * Correctly invoke asyncallback asynchronously
...
==================
  ...
  * deps: debug@~2.1.0
    - Implement `DEBUG_FD` envariable support
  * deps: finalhandler@0.3.1
    - Terminate in progress response only on error
    - Use `on-finished` to determine requestatus
    - deps: debug@~2.1.0
...
==================
  ...
  * deps: finalhandler@0.1.0
    - Respond afterequest fully read
    - deps: debug@1.0.4
  * deps: parseurl@~1.2.0
    - Cache URLs based on original value
    - Remove no-longer-needed URL mis-parse work-around
    - Simplify the "fast-path" `RegExp`
  * perf: reducexecuted logic in routing
...
==================
  ...
  * deps: debug@1.0.3
    - Add support for multiple wildcards inamespaces
  * deps: parseurl@~1.1.3
...
=======================
  ...
  * Prevent default 404 handler afteresponsent
  * dep: debug@0.8.1
...
===================
  ...
  * deps: body-parser@~1.13.1
    ...
    - Change `type` defaulto `application/json` for JSON parser
    - Change `type` defaulto `application/x-www-form-urlencoded` for urlencoded parser
    - Provide static `require` analysis
    - Use the `http-errors` module to generaterrors
    - deps: bytes@2.1.0
  ...
  * deps: bytes@2.1.0
    ...
    - Units no longer casensitive when parsing
  * deps: compression@~1.5.0
    ...
    - perf: simplify thresholdetection
  * deps: cookie@0.1.3
    - Slight optimizations
  ...
  * deps: errorhandler@~1.4.0
    - Add charseto the `Content-Type` header
    - Support `statusCode` property on `Error` objects
    - deps: accepts@~1.2.9
    - deps: escape-html@1.0.2
  ...
  * deps: morgan@~1.6.0
    ...
    - Fix `status` token incorrectly displaying beforesponse in `dev` format
    ...
    - pref: remove dynamicompile on every request for `dev` format
  ...
  * deps: serve-index@~1.7.0
    ...
    - Send non-chunked response for `OPTIONS`
    - Stat parent directory whenecessary
...
===================
  ...
  * deps: body-parser@~1.12.4
    - Slight efficiency improvement whenot debugging
    - deps: debug@~2.2.0
    - deps: depd@~1.0.1
...
===================
  ...
  * deps: response-time@~2.3.0
    - Add function argumento support recording of response time
...
===================
  ...
  * deps: serve-static@~1.8.1
    - Fix redirect loop inode.js 0.11.14
...
===================
  ...
  * deps: express-session@~1.10.1
    - deps: uid-safe@~1.0.2.28.0 / 2015-01-05
===================
  ...
  * deps: compression@~1.3.0
    - Exporthe default `filter` function for wrapping
    - deps: accepts@~1.2.2
    - deps: debug@~2.1.1
  ...
  * deps: errorhandler@~1.3.2
    - Add `log` option
    - Fix heading contento not include stack
    - deps: accepts@~1.2.2
...
===================
  ...
  * deps: serve-index@~1.5.2
    - Fix iconame background alignment on mobile view
  * deps: type-is@~1.5.4
    - deps: mime-types@~2.0.4
...
===================
  ...
  * deps: body-parser@~1.9.0
    ...
    - include thencoding in "unsupported content encoding" error message
    - deps: depd@~1.0.0
  * deps: compression@~1.2.0
    - deps: debug@~2.1.0
  * deps: connect-timeout@~1.4.0
    - Createrrors with `http-errors`
    - deps: debug@~2.1.0
  * deps: debug@~2.1.0
    - Implement `DEBUG_FD` envariable support
  * deps: depd@~1.0.0
  ...
  * deps: response-time@~2.2.0
    ...
    - Add `suffix` option
    - Change `digits` argumento an `options` argument
    - deps: depd@~1.0.0
  * deps: serve-favicon@~2.1.6
    - deps: etag@~1.5.0
  * deps: serve-index@~1.5.0
    - Add `dir` argumento `filter` function
...
===================
  ...
  * deps: errorhandler@~1.2.2
    - deps: accepts@~1.1.2.26.5 / 2014-10-08
===================
...
===================
  ...
  * deps: type-is@~1.5.2
    - deps: mime-types@~2.0.2.26.3 / 2014-09-24
===================
...
===================
  ...
  * deps: body-parser@~1.8.3
    - deps: qs@2.2.4
  * deps: qs@2.2.4
    - Fix issue with object keystarting with numbers truncated
...
===================
  ...
  * deps: serve-static@~1.6.2
    - deps: send@0.9.2.26.0 / 2014-09-08
===================

  * deps: body-parser@~1.8.1
    - add `parameterLimit` option to `urlencoded` parser
    - change `urlencoded` extended array limito 100
    - makempty-body-handling consistent between chunked requests
  ...
  * deps: errorhandler@~1.2.0
    - Display error using `util.inspect` if notherepresentation
    - deps: accepts@~1.1.0
...
===================
  ...
  * deps: express-session@~1.7.6
    - Fix exception `res.end(null)` calls
  * deps: morgan@~1.2.3
    - deps: on-finished@2.1.0
...
===================
  ...
  * deps: serve-static@~1.5.2
    - deps: send@0.8.2.25.5 / 2014-08-11
===================
...
===================
  ...
  * Fix `query` middleware breaking with argument
    - It nevereally took one in the first place
...
===================
  ...
  * deps: csurf@~1.4.0
    ...
    - Calling `res.csrfToken()` after `req.session.destroy()` will nowork
  * deps: express-session@~1.7.4
    - Fix `res.end` patch to call correct upstream `res.write`
    - Fix responsendelay for non-chunked responses
  * deps: qs@1.0.2
    - Complete rewrite
...
===================
  ...
  * deps: morgan@~1.2.2
  * deps: serve-static@~1.4.2.24.1 / 2014-07-26
===================
...
===================
  ...
  * deps: multiparty@3.3.0
    ...
    - Fix callback hang inode.js 0.8 on errors
  * deps: serve-static@~1.3.0
    - Accept string for `maxAge` (converted by `ms`)
    - Add `setHeaders` option
    - Include HTMLink in redirect response
    - deps: send@0.5.0
...
===================
  ...
  * deps: express-session@~1.5.0
    ...
    - Directly read cookies; `cookie-parser` no longerequired
    - Directly set cookies; `res.cookie` no longerequired
...
===================
  ...
  * deps: type-is@1.3.1
    - fix global variableak

2.20.0 / 2014-06-19
===================

  * deprecate `verify` option to `json` -- use `body-parser` npmodule instead
  * deprecate `verify` option to `urlencoded` -- use `body-parser` npmodule instead
...
===================
  ...
  * deps: serve-static@1.2.3
    - Do nothrow un-catchablerror on file open race condition
    - deps: send@0.4.3
...
===================
  ...
  * deps: compression@1.0.6
    ...
    - fix regression whenegotiation fails
...
===================
  ...
  * deprecate `methodOverride()` -- use `method-override` npmodule instead
  ...
  * deps: response-time@2.0.0
    - add `digits` argument
    - do not overridexisting `X-Response-Time` header
    - timer not subjecto clock drift
    - timeresolution down to nanoseconds
...
===================
  ...
  * deps: serve-index@1.1.0
    - Fix content negotiation wheno `Accept` header
    - Properly support all HTTP methods
    - Support vanilla node.js http servers
    - Treat `ENAMETOOLONG` as code 414
    - Use accepts for negotiation
  * deps: serve-static@1.2.0
    - CalculateTag with md5 foreduced collisions
    - Fix wrong behavior when index file matches directory
    - Ignore stream errors afterequest ends
    - Skip directories index file search
    - deps: send@0.4.0
...
===================
  ...
  * deps: body-parser@1.2.2
    - invoke `next(err)` afterequest fully read
    - deps: raw-body@1.1.6
...
===================
  ...
  * deps: morgan@1.1.1
    ...
    - fix `:status` + immediate output inode.js 0.8
    - improve `buffer` option to prevent indefinitevent loop holding
...
===================
  ...
  * fix `connect.version` to reflecthe actual version
...
===================
  ...
  * dep: errorhandler@1.0.1
    * Clean up error CSS
    * Do not respond after headersent
 ...
 * directory: userve-index
 * errorHandler: userrorhandler
 * favicon: use static-favicon
 * logger: use morgan
 * methodOverride: use method-override
 * responseTime: use response-time
 * session: usexpress-session
 * static: userve-static
 ...
 * errorHandler: endefault 404 handler with a newline #972 @rlidwka
 * session: remove long cookiexpire check #870 @undoZen
 ...
 * fixed: set headers written by writeHead beforemitting 'header'
 ...
 * fix fully qualifiedomainame mounting. #920 (@dougwilson)
 ...
 * multipart: addocs regarding tmpfiles
 * multipart: add .name back to file parts
 * multipart: use multiparty instead oformidable
 ...
 * csrf: prevent salt generation every request, and add async req.csrfToken(fn)
...
==================
  ...
  * remove "static" functioname. Closes #794
  * update node-formidable
  * update buffer-crc32.7.6 / 2013-04-15
==================
...
==================
  ...
  * limit: do not consume request inode 0.10.x

2.7.4 / 2013-04-01
==================

  * session: add long expires check and prevent excesset-cookie
...
==================
  ...
  * add utf-8 metag to support foreign characters in filenames/directories
...
==================
  ...
  * fix mount path casensitivity. Closes #663
...
==================
  ...
  * addouble-encoding protection to `compress()`. Closes #659
...
==================
  ...
  * add "pause" util dep
  * update sendep for normalization bug

2.3.9 / 2012-07-16
==================

  * add more descriptive invalid json error message
  * update sendep foroot normalization regression
...
==================
  ...
  * Added supporto csrf middle for pre-flight CORS requests
  * Updated `engines` to allow newer version of node
  * Removeduplicate repo prop. Closes #560
...
==================
  ...
  * Fixed: emit drain compress middleware [nsabovic]
...
==================
  ...
  * Changed `cookieParser()` signed cookie supporto use SHA-2 [senotrusov]
...
==================
  ...
  * Added `cookieParser(secret)` support so anything using this middleware may accessigned cookies
  * Added signed cookie supporto `cookieParser()`
  * Added support for JSON-serialized cookies to `cookieParser()`
  * Added `err.status` support in Connect's default end-point
  * Added X-Cache MISS / HITo `staticCache()`
  ...
  * Removed `http[s].Server` inheritance, now just a function, making it easy to have an approviding bothttp and https
...
==================
  ...
  * Added _multipart/form-data_ supporto `bodyParser()` using formidable

1.7.3 / 2011-11-11
==================

  * Fixed `req.body`, always defaulto {}
...
==================
  ...
  * Added backpressure supporto `staticCache()`
...
==================
  ...
  * Added public `res.headerSent` checking nodes `res._headerSent` (remove whenode adds this)
  * Changed: ignorerror handling middleware when header isent
  * Changed: dispatcherrors after header isent destroy the sock

1.6.4 / 2011-08-26
==================

  * Revert "Addedouble-next reporting"

1.6.3 / 2011-08-26
==================

  * Addedouble-`next()` reporting
...
==================
  ...
  * Fixed `res._headers` loggeregression. Closes #318
...
==================
  ...
  * Changed `connect.static()` to check resolvedirname. Closes #294
...
==================
  ...
  * Fixed stream creation `static()` __HEAD__ request. [Andreas Lind Petersen]
  * Fixed Win32 support for `static()`
  * Fixed monkey-patch issue. Closes #261.4.1 / 2011-05-08
==================
...
==================
  ...
  * Added route-middleware `next('route')` supporto jumpassed the route itself
  * Added Content-Length supporto `limit()`
  * Added route-specific middleware support (used to be in express)
  * Changed; refactoreduplicate session logic
  * Changed; prevent redefining `store.generate` perequest
...
==================
  ...
  * Added `logger()` support format function
...
==================
  ...
  * Added request "limit" evento `limit()` middleware
...
==================
  ...
  * Added callback supporto `connect.static.send()` for express
...
==================
  ...
  * Added Range supporto `static()`
  * Added HTTPSupport
  * Rewrote session middleware. The session API now allows for
    session-specificookies, so you may alter each individually.
  ...
  * Added middleware self-awareness. This helps prevent
    ...
    than onceven when within a mounted server.
...
==================
  ...
  * Fixedirectory traversal attack in `staticProvider`. Closes #198
...
==================
  ...
  * Added `qs` dependency
  * Fixed routerace-condition causing possible failure
    when `next()`ing tone or more routes with parallel
    requests

0.5.7 / 2011-02-01
==================

  * Added `onvhost()` call so Express (and others) can knowhen they are
  * Revert "Added stylusupport" (use the middleware which ships with stylus)
  * Removed custom `Server#listen()` to allow regular `http.Server#listen()` args to work properly
  * Fixed long standing router issue (#83) that causes '.' to be disallowed withinamed placeholders in routes [Andreas Lind Petersen]
...
==================
  ...
  * Changed; generated a longerandom UID, withoutime influence. [Paul Querna]
  * Fixed; session middleware throws when secret is not present. [Paul Querna]

0.5.4 / 2011-01-07
==================

  * Added; throwhen router path or callback is missing
  * Fixed; `next(err)` on cookie parsexception instead of ignoring
...
==================
  ...
  * Removed bad outdatedocs, we need something new / automated eventually

0.5.2 / 2010-12-28
==================

  * Addedefault __OPTIONS__ supporto _router_ middleware
...
==================
  ...
  * Added named capture group supporto router
...
==================
  ...
  * Added option supporto _staticProvider_, canow pass _root_ and _lifetime_.
  * Added; mounted `Server` instances now have the `route` property exposed foreflection
...
==================
  ...
  * Changed `res.redirect("back")` to defaulto "/" when Referr?er is not present
  * Fixed _staticProvider_ urlencoded paths issue. Closes #47
  * Fixed _staticProvider_ middlewaresponding to **GET** requests
...
==================
  ...
  * Addedocs for several more middleware layers
  * Added `connect.Server#use()`
  * Added _compiler_ middleware which provides arbitrary staticompilation
...
==================
  ...
  * Added _static_ middleware usagexample
  * Added support foregular expressions as paths for _router_
  * Added `util.merge()`
...
==================
  ...
  * Addedocumentation for several middleware
  ...
  * Added `utils.uid()`
  * Added bin/connect appath and --config path support for .jsuffix, although optional. Closes #26
...
==================
  ...
  * Added --workersupporto bin/connect stop and status commands
  * Added _redirect_ middleware
  * Added better --config supporto bin/connect. All flags can be utilized
  * Added auto-detection of _./config.js_
  * Added config example
  * Added `net.Server` supporto bin/connect
...
==================
  ...
  * Fixed nodependency in package.json, now _">= 0.1.98-0"_ to support __HEAD__
...
==================
  ...
  * Added custom log format supporto _log_ middleware
  * Added arbitrary envariable supporto bin/connect (ext: --logFormat ":method :url")
