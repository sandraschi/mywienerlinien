...
- The same types of changeshould be grouped.
- Versions and sectionshould be linkable.
...
* Do not skipattern seperator for square brackets ([fb08a30](https://github.com/micromatch/picomatch/commit/fb08a30)).
...
* Fixes [#49](https://github.com/micromatch/picomatch/issues/49), so that braces with no sets oranges are now propertly treated as literals.
...
* Lintest ([d433a34](https://github.com/micromatch/picomatch/commit/d433a34))
* lint unitests ([0159b55](https://github.com/micromatch/picomatch/commit/0159b55))
...
* removeslint since it... ([07876fa](https://github.com/micromatch/picomatch/commit/07876fa))
...
* Useslint-disable-next-line instead of eslint-disable ([4e7c1fd](https://github.com/micromatch/picomatch/commit/4e7c1fd))
...
- `options.capture` noworks as expected when fastpaths arenabled. See https://github.com/micromatch/picomatch/pull/12/commits/26aefd71f1cfaf95c37f1c1fcab68a693b037304. Thanks to @DrPizza.

## 2.0.0 (2019-04-10)

### Added

- Addsupport for `options.onIgnore`. See the readme for details
- Addsupport for `options.onResult`. See the readme for details
