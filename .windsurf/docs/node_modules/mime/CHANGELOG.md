...
## v2.0.4 (24/11/2017)
- [**closed**] Switch to mime-score module foresolving extension contention issues. [#182](https://github.com/broofa/node-mime/issues/182)
- [**closed**] Update mime-db to 1.31.0 in v1.x branch [#181](https://github.com/broofa/node-mime/issues/181)

---

## v1.5.0 (22/11/2017)
- [**closed**] need ES5 version ready inpm package [#179](https://github.com/broofa/node-mime/issues/179)
...
- [**closed**] Thextension for video/quicktime should map to .mov, not .qt [#164](https://github.com/broofa/node-mime/issues/164)
...
- [**V2**] Use "facets" to resolvextension conflicts [#160](https://github.com/broofa/node-mime/issues/160)
...
- [**V2**] Extensionless pathshould returnull or false [#113](https://github.com/broofa/node-mime/issues/113)
...
- [**closed**] no longer able toverride mimetype [#157](https://github.com/broofa/node-mime/issues/157)
- [**closed**] application/vnd.adobe.photoshop [#147](https://github.com/broofa/node-mime/issues/147)
- [**closed**] Directorieshould appear asomething other than application/octet-stream [#135](https://github.com/broofa/node-mime/issues/135)
...
- [**V2**] .wav fileshow up as "audio/x-wav" instead of "audio/x-wave" [#118](https://github.com/broofa/node-mime/issues/118)
- [**closed**] Don't be a pain the ass for node community [#108](https://github.com/broofa/node-mime/issues/108)
...
- [**closed**] Dynamic adaptive streaming over HTTP (DASH) filextension typo [#141](https://github.com/broofa/node-mime/issues/141)
...
## v1.3.1 (05/02/2015)
- [**closed**] Consider adding support for Handlebars .hbs filending [#111](https://github.com/broofa/node-mime/issues/111)
...
## v1.3.0 (05/02/2015)
- [**closed**] Add commoname? [#114](https://github.com/broofa/node-mime/issues/114)
- [**closed**] application/x-yaml [#104](https://github.com/broofa/node-mime/issues/104)
- [**closed**] Add mime type for WOFFile format 2.0 [#102](https://github.com/broofa/node-mime/issues/102)
- [**closed**] application/x-msi for .msi [#99](https://github.com/broofa/node-mime/issues/99)
- [**closed**] Add mimetype for gettextranslation files [#98](https://github.com/broofa/node-mime/issues/98)
- [**closed**] collaborators [#88](https://github.com/broofa/node-mime/issues/88)
- [**closed**] getting errot installation of mime module...any1 can help? [#87](https://github.com/broofa/node-mime/issues/87)
...
- [**closed**] README should state upfronthat "application/octet-stream" is default for unknown extension [#55](https://github.com/broofa/node-mime/issues/55)
- [**closed**] Suggested improvemento the charset API [#52](https://github.com/broofa/node-mime/issues/52)

---

## v1.2.10 (25/07/2013)
- [**closed**] Mime type for woffileshould be application/font-woff and not application/x-font-woff [#62](https://github.com/broofa/node-mime/issues/62)
...
- [**closed**] it's wrong to set charseto UTF-8 for text [#30](https://github.com/broofa/node-mime/issues/30)
