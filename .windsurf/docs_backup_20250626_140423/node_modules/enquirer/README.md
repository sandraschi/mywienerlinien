...
<p align="center">
  ...
  <sub>>_ Prompts should be more like conversations than inquisitionsâ–Œ</sub>
</p>
...
<p align="center">
  <b>>_ Ready to start making prompts your users will love? â–Œ</b><br>
...
**Jump to**: [Getting Started](#-getting-started) Â· [Prompts](#-prompts) Â· [Options](#prompt-options) Â· [Key Bindings](#-key-bindings)
...
**â†‘ back to:** [Getting Started](#-getting-started) Â· [Prompts](#-prompts)
...
| **Method** | **Description** |
| --- | --- |
| `pointer()` | Returns the visual symbol to use to identify the choice that currently has focus. The `â¯` symbol is often used for this. The pointer is not always visible, as with the `autocomplete` prompt. |
...
Please see [CHANGELOG.md](/node_modules/enquirer/CHANGELOG.md).
...
_(This project's readme.md is generated by [verb](https://github.com/verbose/verb-generate-readme), please don't edit the readme directly. Any changes to the readme must be made in the [.verb.md](/node_modules/enquirer/.verb.md) readme template.)_
...
Copyright Â© 2018-present, [Jon Schlinkert](https://github.com/jonschlinkert).
