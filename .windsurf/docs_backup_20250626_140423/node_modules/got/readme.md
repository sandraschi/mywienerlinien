...
[Moving from Request?](/node_modules/got/migration-guides.md)
...
Called with plain [request options](#options), right before their normalization. This is especially useful in conjunction with [`got.extend()`](#instances) and [`got.create()`](/node_modules/got/advanced-creation.md) when the input needs custom handling.
...
Called with [normalized](source/normalize-arguments.js) [request options](#options). Got will make no further changes to the request before it is sent. This is especially useful in conjunction with [`got.extend()`](#instances) and [`got.create()`](/node_modules/got/advanced-creation.md) when you want to create an API client that, for example, uses HMAC-signing.
...
**Tip:** Need more control over the behavior of Got? Check out the [`got.create()`](/node_modules/got/advanced-creation.md).
...
**Note:** Not to be confused with [`got.create()`](/node_modules/got/advanced-creation.md), which has no defaults.
...
|-----------------------|:--------------:|:---------------:|:------------------:|:---------------:|:--------------------:|
| HTTP/2 support        |        â”       |        âœ–       |          âœ–         |        âœ–       |          âœ”\*\*      |
| Browser support       |        âœ–       |        âœ–       |          âœ”\*       |        âœ”       |          âœ”          |
| Electron support      |        âœ”       |        âœ–       |          âœ–         |        âœ–       |          âœ–          |
| Promise API           |        âœ”       |        âœ”       |          âœ”         |        âœ”       |          âœ”          |
| Stream API            |        âœ”       |        âœ”       |    Node.js only    |        âœ–       |          âœ”          |
| Request cancelation   |        âœ”       |        âœ–       |          âœ”         |        âœ”       |          âœ”          |
| RFC compliant caching |        âœ”       |        âœ–       |          âœ–         |        âœ–       |          âœ–          |
| Cookies (out-of-box)  |        âœ”       |        âœ”       |          âœ–         |        âœ–       |          âœ–          |
| Follows redirects     |        âœ”       |        âœ”       |          âœ”         |        âœ”       |          âœ”          |
| Retries on failure    |        âœ”       |        âœ–       |          âœ–         |        âœ–       |          âœ”          |
| Progress events       |        âœ”       |        âœ–       |          âœ–         |  Browser only  |          âœ”          |
| Handles gzip/deflate  |        âœ”       |        âœ”       |          âœ”         |        âœ”       |          âœ”          |
| Advanced timeouts     |        âœ”       |        âœ–       |          âœ–         |        âœ–       |          âœ–          |
| Timings               |        âœ”       |        âœ”       |          âœ–         |        âœ–       |          âœ–          |
| Errors with metadata  |        âœ”       |        âœ–       |          âœ–         |        âœ”       |          âœ–          |
| JSON mode             |        âœ”       |        âœ”       |          âœ–         |        âœ”       |          âœ”          |
| Custom defaults       |        âœ”       |        âœ”       |          âœ–         |        âœ”       |          âœ–          |
