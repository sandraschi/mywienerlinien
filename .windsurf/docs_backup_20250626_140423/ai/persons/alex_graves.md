# Alex Graves (1981-Present)

## Overview
Alex Graves is a British computer scientist and research scientist at DeepMind, specializing in deep learning, particularly in the areas of recurrent neural networks (RNNs), sequence prediction, and reinforcement learning. He is best known for his work on long short-term memory (LSTM) networks, connectionist temporal classification (CTC), and neural Turing machines (NTMs). Graves' research has had a significant impact on speech recognition, handwriting recognition, and sequence modeling.
...
## Key Contributions
- Development of connectionist temporal classification (CTC) for sequence learning
- Advancements in long short-term memory (LSTM) networks
- Invention of neural Turing machines (NTMs) and differentiable neural computers (DNCs)
- Research on attention mechanisms in neural networks
...
- **Reception**: Influenced research in neural algorithmic reasoning

## Publications
- "Framewise Phoneme Classification with Bidirectional LSTM and Other Neural Network Architectures" (2005) - IJCNN
...
## Awards and Honors
- Best Paper Award, IEEE International Conference on Neural Networks (2006)
- Outstanding Paper Award, Neural Information Processing Systems (2016)
- Featured in MIT Technology Review's 35 Innovators Under 35 (2017)
...
- [Connectionist Temporal Classification](https://www.cs.toronto.edu/~graves/icml_2006.pdf) - Original CTC paper
